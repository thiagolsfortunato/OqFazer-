...
public enum City {
	...
	SAO_JOSE_DOS_CAMPOS("São José dos Campos"), TAUBATE("Taubaté"), CACAPAVA("Caçapava"), JACAREI("Jacareí"), PINDAMONHANGABA("Pindamonhangaba"),
	SAO_PAULO("São Paulo"), GUARULHOS("Guarulhos"), ARUJA("Arujá"), 
	CARAGUATATUBA("Caraguatatuba"), UBATUBA("Ubatuba"), ILHA_BELA("Ilhabela"), SAO_SEBASTIAO("São Sebastião");
