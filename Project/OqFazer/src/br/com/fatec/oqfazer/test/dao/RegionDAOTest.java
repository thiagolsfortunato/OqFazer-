...
public class RegionDAOTest extends TestBase{
	...
	public void testUpdate() {
		...
		Assert.assertEquals(new Long(1), updatedRegion.getId());
	...
	public void testFindAll() {	
		...
		Assert.assertEquals(new Long(1), listRegions.get(0).getId());
		Assert.assertEquals("Sentido Rio", listRegions.get(0).getName());
				
		Assert.assertEquals(new Long(2), listRegions.get(1).getId());
