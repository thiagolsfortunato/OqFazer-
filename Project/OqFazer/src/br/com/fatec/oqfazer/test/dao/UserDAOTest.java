...
public class UserDAOTest extends TestBase{
	...
	public void testSave(){
		...
		Assert.assertEquals(new Long(1), savedUser.getId());
	...
	public void testUpdate() {
		...
		Assert.assertEquals(new Long (1), atualizedUser.getId());
	...
	public void testFindAll() {
		...
		Assert.assertEquals(new Long (1), listUsers.get(0).getId());
		Assert.assertEquals("william", listUsers.get(0).getName());
		Assert.assertEquals("williamcezart@gmail.com", listUsers.get(0).getEmail());
		Assert.assertEquals("facebook", listUsers.get(0).getPassword());
		Assert.assertEquals(36535959, listUsers.get(0).getPhone());
		
		Assert.assertEquals(new Long (2), listUsers.get(1).getId());
